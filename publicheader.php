...
<body>
	...
	<a href="customer_registration.php">Customer Registration</a> -->
	<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container">
      <div class="header-container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
          <ul>
            <li><a class="nav-link scrollto" href="public_home.php">Home</a></li>
            <li><a class="nav-link scrollto" href="public_login.php">Login</a></li>
            <li><a class="nav-link scrollto" href="customer_registration.php">Customer Registration</a></li>
            <li><a class="nav-link scrollto" href="index.php">Our Products</a></li>
